...
public class ImageLoader {
    ...
    public Bitmap getCacheBitmap(String requestUrl,int maxWidth,int maxHeight){
        if(requestUrl != null && !requestUrl.isEmpty()){
            if(requestUrl.startsWith("file")) {
                return getLocalCacheBitmap(requestUrl,maxWidth,maxHeight);
            }
        }
    ...
    public Bitmap getLocalCacheBitmap(String requestUrl,int maxWidth,int maxHeight){
        final String cacheKey = getCacheKey(requestUrl, maxWidth, maxHeight);
        ...
        if(cachedBitmap == null || cachedBitmap.isRecycled()){
            ...
            String url = requestUrl.substring(6,requestUrl.length());
            ...
            cachedBitmap = BitmapFactory.decodeFile(url, opt);

//            cachedBitmap = BitmapFactory.decodeFile(requestUrl.substring(6,requestUrl.length()));
            if(cachedBitmap != null) {
                mCache.putBitmap(cacheKey, cachedBitmap);
            }
            Log.d("getLocalCacheBitmap","get from local");
        }else{
            Log.d("getLocalCacheBitmap","get from cache");
        }
        return cachedBitmap;
    }
